...
## Plan 0 — Create `.env.example` *(~30 min)*
...
## Plan 1 — Split `_app.ts` Into Domain Sub-Routers *(2–4 hr)*
...
## Plan 2 — Fix RAG SQL Injection *(1 hr)*
...
## Plan 3 — MCP Server Management *(1–2 days)*
...
## Plan 4 — GitHub Copilot OAuth (Device Flow) *(2–3 days)*
...
## Plan 5 — Gemini API Key UX Improvements *(2 hr)*
...
## Plan 6 — Message Branching UI *(1 day)*
...
## Plan 7 — Memory Extraction After Every Response *(1 day)*
...
## Plan 9 — Dynamic Model List *(1 day)*
...
## Plan 10 — Agent Export Button *(2 hr)*
